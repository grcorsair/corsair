...
cat <<'JSON' > evidence.json
{
  "metadata": {
    "title": "Acme Corp Security Assessment",
    "date": "2026-02-01",
    "issuer": "Acme Corp Security Team",
    "scope": "Production AWS account"
  },
  "controls": [
    {
      "id": "CTRL-001",
      "description": "MFA enforced for console access",
      "status": "pass",
      "severity": "HIGH",
      "evidence": "All human users have MFA enabled."
    }
  ]
}
JSON

# Sign the evidence into a CPOE
