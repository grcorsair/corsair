...
Scan trust-center pages for a domain (for example `trust.gitlab.com`) and return a persisted roast report across discoverability, verifiability, freshness, machine readability, and transparency.
...
| Field | Type | Required | Description |
|:------|:-----|:---------|:-----------|
| `domain` | string | Yes | Domain or URL to scan, e.g. `trust.gitlab.com` or `https://trust.gitlab.com` |
