...
description: "Use @grcorsair/sdk to integrate Corsair signing, verification, and management into your applications."
...
```bash
# From the monorepo (recommended until npm release)
git clone https://github.com/grcorsair/corsair.git
cd corsair
bun install

# npm (coming soon)
# npm install @grcorsair/sdk
```
