...
Layer 2 adds intelligence on top of Layer 1's cryptographic signing infrastructure. While Layer 1 answers "is this evidence signed and verifiable?", Layer 2 answers "how good is this evidence?"
...
Layer 2 outputs become inputs to Layer 3 (Decision):

| Layer 2 Output | Layer 3 Consumer | How It Is Used |
|---------------|------------------|----------------|
