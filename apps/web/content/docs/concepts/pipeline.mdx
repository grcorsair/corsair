...
If your GRC team doesn’t control the root domain, use a delegated subdomain (for example `trust.example.com`). See the [IT request template](/docs/getting-started/it-request).
