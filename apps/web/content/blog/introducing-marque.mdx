...
The vendor runs their security tools (Prowler, InSpec, Trivy) and feeds the structured output to Corsair. Corsair classifies the evidence, maps it to compliance frameworks, and signs the results as a JWT-VC with Ed25519. The resulting Marque can be verified by **anyone** — using Corsair tooling, any W3C VC verifier, or any JWT library with EdDSA support. No Corsair account needed, no server calls, no data sharing.
