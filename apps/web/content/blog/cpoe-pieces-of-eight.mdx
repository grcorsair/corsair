...
Corsair bridges this gap. Run `corsair sign --format prowler --file scan-results.json` and the tool output becomes a signed CPOE — a W3C Verifiable Credential that anyone can verify with standard JWT libraries and the issuer's public key.
