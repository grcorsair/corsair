...
description: "How Corsair uses W3C Verifiable Credentials, OpenID SSF/CAEP, and IETF SCITT to turn compliance evidence into interoperable cryptographic proof."
date: "2026-02-07"
tag: "Protocol"
published: true
---

Today we're shipping **Parley** — Corsair's standards-based trust exchange protocol. CPOEs (Certificates of Proof of Operational Effectiveness) are W3C Verifiable Credentials, compliance changes are broadcast via OpenID SSF/CAEP, and transparency logging follows the IETF SCITT architecture. The pipeline is simple: INGEST evidence, CHART framework mappings, QUARTER governance review, MARQUE the signed proof.
...
- **Pirate names** — INGEST, CHART, QUARTER, MARQUE (and FLAGSHIP for real-time signals)
...
The core thesis: verify trust, don't assume it. Compliance evidence is wrapped in standards that anyone can verify.
