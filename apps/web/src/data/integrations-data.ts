...
export const CATEGORIES: IntegrationCategoryMeta[] = [
  {
    ...
    pirateName: "LOOKOUT",
    description:
      "Mapping packs and generic JSON ingestion. Auto-detected via the registry.",
  },
  {
    id: "sign-verify",
    name: "Sign & Verify",
...
export const INTEGRATIONS: Integration[] = [
  // ── Evidence Sources ─────────────────────────────────────────────────
  {
    ...
    status: "available",
    description: "Config-driven mappings that turn tool output into controls",
    docsUrl: "/docs/getting-started/quick-start",
    snippet: "corsair sign --file evidence.json --mapping ./mappings/toolx.json",
  },
  {
    id: "generic-json",
    name: "Generic JSON",
