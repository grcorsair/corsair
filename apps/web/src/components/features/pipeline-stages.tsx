...
const stages = [
  ...
  {
    name: "SIGN",
    description: "Record provenance and sign as a JWT-VC (Ed25519, did:web) — a cryptographically verifiable CPOE",
  ...
  {
    name: "LOG",
    description: "Register in an append-only SCITT transparency log with COSE receipts and Merkle proofs",
  ...
  {
    name: "VERIFY",
    description: "Anyone can verify a CPOE using standard JWT libraries and the issuer's public key via DID:web",
  ...
  {
    name: "DIFF",
    description: "Compare two CPOEs to detect compliance regressions, improvements, and new controls over time",
