...
export const CLI_REFERENCE: CLICommandReference[] = [
  {
    ...
    options: [
      ...
      { flag: "--auth-token <TOKEN>", description: "Use API signing with a Bearer token (API key or OIDC)." },
      { flag: "--api-url <URL>", description: "API base URL for keyless signing." },
      { flag: "--register-scitt", description: "Register signed CPOE in SCITT log (API only)." },
      ...
      { flag: "--quiet", description: "Suppress stderr output." },
      { flag: "--verbose", description: "Verbose progress output." },
    ],
    examples: [
  ...
  },
  {
    ...
    options: [
      ...
      { flag: "--url <URL>", description: "Fetch and verify CPOE from URL." },
      { flag: "--domain <DOMAIN>", description: "Resolve trust.txt/catalog and verify latest CPOE." },
      ...
      { flag: "--all", description: "Verify all CPOEs when using --domain." },
      { flag: "--json", description: "Machine-readable output." },
    ],
  },
  {
    ...
    usage: [
      "corsair diff --current <new.jwt> --previous <old.jwt> [options]",
      "corsair diff --domain <DOMAIN> [options]",
    ],
    options: [
      { flag: "--current <PATH>", description: "Newer CPOE JWT." },
      { flag: "--previous <PATH>", description: "Older CPOE JWT." },
      { flag: "--domain <DOMAIN>", description: "Resolve trust.txt/catalog and diff latest CPOEs." },
  ...
  {
    command: "signal stream",
    summary: "Manage SSF streams for FLAGSHIP event delivery.",
    usage: [
      "corsair signal stream create [options]",
    ...
    options: [
      { flag: "--auth-token <TOKEN>", description: "API key or OIDC bearer token." },
      { flag: "--api-url <URL>", description: "API base URL (defaults to CORSAIR_API_URL)." },
      { flag: "--delivery <push|poll>", description: "Delivery method for the stream." },
      { flag: "--endpoint <URL>", description: "Push delivery endpoint (required for push)." },
      { flag: "--events <CSV>", description: "Comma-separated event types or aliases." },
      { flag: "--audience <DID>", description: "Audience DID for the stream." },
      { flag: "--stream-id <ID>", description: "Stream ID (get/update/delete)." },
      { flag: "--json", description: "Machine-readable output." },
    ],
  },
  {
