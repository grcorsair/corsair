...
const STRIDE_RULES: Record<string, StrideRule[]> = {
  ...
  "azure-entra": [
    {
      field: "conditionalAccessPolicies",
      condition: (v) => v === false || v === null || v === undefined || (Array.isArray(v) && v.length === 0),
      stride: "ElevationOfPrivilege",
      technique: "T1078.004",
      techniqueName: "Cloud Accounts",
      severity: "CRITICAL",
      description: "No conditional access policies allows unrestricted authentication from any context",
      attackVectors: ["conditional-access-bypass"],
    },
    {
      field: "passwordHashSync",
      condition: (v) => v === true,
      stride: "Spoofing",
      technique: "T1110",
      techniqueName: "Brute Force",
      severity: "HIGH",
      description: "Password hash sync enables offline credential attacks against synced hashes",
      attackVectors: ["password-sync-exploit"],
    },
    {
      field: "mfaConfiguration",
      condition: (v) => v === "OFF" || v === "OPTIONAL" || v === false || v === null,
      stride: "Spoofing",
      technique: "T1621",
      techniqueName: "Multi-Factor Authentication Request Generation",
      severity: "CRITICAL",
      description: "MFA not enforced enables authentication with stolen credentials alone",
      attackVectors: ["mfa-fatigue"],
    },
  ],
...
const THREAT_TO_EXPECTATION: Record<string, ExpectationMapping[]> = {
  ...
  // Azure Entra fields
  "conditionalAccessPolicies": [{ field: "conditionalAccessPolicies", operator: "exists", value: true }],
  "passwordHashSync": [{ field: "passwordHashSync", operator: "eq", value: false }],
};
